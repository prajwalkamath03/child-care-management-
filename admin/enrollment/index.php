				...
				<tbody>
					...
					?>
						<tr>
							...
							<!-- <td><?php echo ucwords($row['drop_time']) ?></td>
							<td><?php echo ucwords($row['pickup_time']) ?></td> -->
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
									...
									<div class="dropdown-divider"></div>
									<a class="dropdown-item" href="./?page=enrollment/manage_enrollment&id=<?= $row['id'] ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
				                    <div class="dropdown-divider"></div>
